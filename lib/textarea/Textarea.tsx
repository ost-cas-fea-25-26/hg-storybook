...
export default function Textarea({ error, ...props }: Props) {
  ...
  const defaultStyle =
    'w-full border-2 border-solid border-secondary-300 focus:border-transparent rounded-md p-4 text-slate-700 text-base custom-placeholder font-medium disabled:custom-disabled min-h-[60px]';
